...
import 'card_aprender_pronuncia.dart';
import 'home_page.dart';
import 'package:flutter/services.dart';
import 'package:audioplayers/audio_cache.dart';

class ModuloAprenderPronuncia extends StatefulWidget {
  final String modoTela;

  ModuloAprenderPronuncia({Key key, @required this.modoTela}) : super(key: key);
  @override
  _ModuloAprenderPronunciaState createState() =>
      _ModuloAprenderPronunciaState(modoTela);
}
...
class _ModuloAprenderPronunciaState extends State<ModuloAprenderPronuncia> {
  ...
  String modoTela;
  _ModuloAprenderPronunciaState(this.modoTela);
              ...
              children: <Widget>[
                FlatButton.icon(
                  ...
                  onPressed: () {
                    ...
                    Navigator.pop(context, CardAprenderPronuncia());
                  },
                  icon: Icon(
