...
class CardLerPalavra extends StatefulWidget {
  @override
  _CardLerPalavraState createState() => _CardLerPalavraState();
}

class _CardLerPalavraState extends State<CardLerPalavra> {
  ...
  void initState() {
    super.initState();
    audioExplicandoCard.play("audios_explicacao/audioCardLerPalavra.mp3");
          ...
          Container(
            child: Padding(
              ...
              child: ClipRRect(
                borderRadius: BorderRadius.circular(40),
                child: Container(
                  child: Image.asset("images/lerPalavra.png",
                      ...
                      onPressed: () {
                        ...
                        if(nivel == ""){
                          ...
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => ModuloLerPalavra(contador: 0, nivel: nivel)));
                        }
                      },
                      label: Text(
                        "Jogar",
