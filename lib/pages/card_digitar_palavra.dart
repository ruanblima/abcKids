...
class CardDigitarPalavra extends StatefulWidget {
  @override
  _CardDigitarPalavraState createState() => _CardDigitarPalavraState();
}

class _CardDigitarPalavraState extends State<CardDigitarPalavra> {
  ...
  void initState() {
    super.initState();
    audioExplicandoCard.play("audios_explicacao/audioCardDigitarPalavra.mp3");
                      ...
                      onPressed: () {
                        ...
                        if(nivel == ""){
                          ...
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) =>
                                      ModuloDigitarPalavra(contador: 0, nivel: nivel)));
                        }
                      },
                      label: Text(
                        "Jogar",
